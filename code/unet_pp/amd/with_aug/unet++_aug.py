...
def build_unetplusplus(input_shape, num_classes):
   ...
   e2, p2 = encoder_block(p1, 48)
   e3, p3 = encoder_block(p2, 96)
   e4, p4 = encoder_block(p3, 192)

   b = conv_block(p4, 384)

   d1_0 = decoder_block(b, e4, 192)
   d1_1 = decoder_block(d1_0, Concatenate()([e3, Conv2DTranspose(96, (2, 2), strides=2, padding="same")(e4)]), 96)
   d1_2 = decoder_block(d1_1, Concatenate()([e2, Conv2DTranspose(48, (2, 2), strides=2, padding="same")(e3), Conv2DTranspose(48, (4, 4), strides=4, padding="same")(e4)]), 48)
   d1_3 = decoder_block(d1_2, Concatenate()([e1, Conv2DTranspose(32, (2, 2), strides=2, padding="same")(e2), Conv2DTranspose(32, (4, 4), strides=4, padding="same")(e3), Conv2DTranspose(32, (8, 8), strides=8, padding="same")(e4)]), 32)

   outputs = Conv2D(num_classes, 1, padding="same", activation="softmax")(d1_3)
...
if __name__ == "__main__":
   ...
   model = build_unetplusplus(input_shape, NUM_CLASSES)
